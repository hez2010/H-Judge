...
namespace hjudgeWeb.Data.Migrations
{
    ...
    [Migration("20181127170443_AddGroupIdFieldInAnnouncement")]
    partial class AddGroupIdFieldInAnnouncement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hjudgeWeb.Data.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("hjudgeWeb.Data.MessageContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("hjudgeWeb.Data.Message", b =>
                {
                    b.HasOne("hjudgeWeb.Data.MessageContent", "MessageContent")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("hjudgeWeb.Data.MessageContent", b =>
                {
                    b.HasOne("hjudgeWeb.Data.Message")
