        ...
        <v-card>
            <v-card-title primary-title>
                ...
                <v-tooltip v-if="user && user.privilege >= 1 && user.privilege <= 2" bottom>
                    <v-btn icon slot="activator" to="/Admin/Problem/0">
            ...
            <v-card-text>
                <v-data-table :headers="headers"
                    ...
                    <template slot="items" slot-scope="props">
                        ...
                        <td><router-link :to="{ path: '/ProblemDetails/' + props.item.id }">{{ props.item.name }}</router-link></td>
                        ...
                        <td v-if="user && user.privilege >= 1 && user.privilege <= 2">
                            <v-layout row>
                                <v-tooltip bottom>
                                    <v-btn icon slot="activator" :to="{ path: '/Admin/Problem/' + props.item.id }">
